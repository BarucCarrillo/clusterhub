...
const adminSensor = () => {
    ...
    const dataVoid = [ [<TextInput placeholder="HOLA" style={styles.tableInput}/>,<TextInput placeholder="HOLA"style={styles.tableInput}/>,<TextInput placeholder="HOLA"style={styles.tableInput}/>,<TextInput placeholder="HOLA"style={styles.tableInput}/>] ]
            ...
            <View>
                ...
                <ScrollView style={styles.sensorConatiner}>
                    <Card containerStyle={{height: 'auto', borderRadius: 5}}>
                        ...
                        <Table>
                            <Row textStyle={{fontWeight: 'bold', textAlign: 'center', fontSize: 18}} data={header}/>
                            <Rows textStyle={{textAlign: 'center', fontSize:14}} data={data}/>
                        </Table>
                ...
                onRequestClose={() => setModalVisible(false)}>
                    <View style={styles.modalContainer}>
                        <View style={styles.modalContent}>
                            <TextInput placeholder='Nombre del Sensor' style={styles.input}></TextInput>
                            <TextInput placeholder='Tipo de Sensor' style={styles.input}></TextInput>
                            <Table>
                                <Row textStyle={{fontWeight: 'bold', textAlign: 'center', fontSize: 18}} data={header}/>
                                <Rows textStyle={{textAlign: 'center', fontSize:14}} data={dataVoid}/>
                            </Table>
                            <View style={styles.btnContainer}>
                                <TouchableOpacity
                                    style={styles.button}
