...
const infoConfig = () => {
  ...
  const [pickedImagePath, setPickedImagePath] = useState(
    "https://th.bing.com/th/id/OIP.NnQzuZFcKjxCImErUgu_fwHaE7?rs=1&pid=ImgDetMain"
  );

  const { user, updateInfoUser } = useGlobalContext();
  ...
  const submit = async () => {
    ...
    try {
      const response = updateInfoUser(form);
      router.push("/home");
